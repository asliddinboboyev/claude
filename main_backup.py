...
.chat{position:fixed;right:22px;bottom:96px;width:420px;height:660px;max-width:calc(100vw - 28px);max-height:calc(100vh - 110px);background:#fff;border-radius:20px;box-shadow:0 20px 60px rgba(0,0,0,.18);display:none;flex-direction:column;z-index:99}
...
Qanday savol bor?</div></div>
      ...
      <div class="chips">
        <button class="chip" data-q="Metformin va Enalapril birga ichsa bo'ladimi? O'zaro ta'siri bormi?">Dori ta'sirlari</button>
        <button class="chip" data-q="HbA1c 8.5% bo'lsa nima degani va nima qilish kerak?">HbA1c tahlil</button>
        <button class="chip" data-q="Bisoprolol to'satdan to'xtatsa nima bo'ladi?">Bisoprolol</button>
        <button class="chip" data-q="Atorvastatin ichgandan keyin mushagim og'riyapti, rabdomioliz xavfi bormi?">Statin yon ta'sir</button>
        <button class="chip" data-q="Warfarin INR 3.8 bo'lsa nima qilish kerak?">Warfarin INR</button>
      </div>
...
function startChat(){
  ...
  if(!k.startsWith('sk-ant')){alert("Noto'g'ri kalit formati. sk-ant- bilan boshlanishi kerak");return}
